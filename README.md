...
- [快速上手](./docs/guide/quickstart.md) — 5 分钟跑通第一个 stoma 测试，了解核心概念与项目结构。文档涵盖环境搭建、CLI 安装与第一个测试的完整流程
...
- [stoma-make](./docs/codegen/stoma-make.md) — 命令行工具完整参考：选项、生成规则、输出布局与多语言支持
...
5 分钟上手：[`guide/quickstart.md`](./docs/guide/quickstart.md)
